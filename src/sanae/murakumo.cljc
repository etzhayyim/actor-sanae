...
(def actor-did
  "did:web:etzhayyim.com:actor:sanae")
...
(defn collection
  [name]
  (str "com.etzhayyim.sanae." name))

(def cell-specs {
  :field_preparation {:legacy-cell "field-preparation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "field_preparation")]
     :required-gates common-gates
     :trigger "manifest cell field_preparation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :precision_seeding {:legacy-cell "precision-seeding"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "precision_seeding")]
     :required-gates common-gates
     :trigger "manifest cell precision_seeding"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :autonomous_weeding {:legacy-cell "autonomous-weeding"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "autonomous_weeding")]
     :required-gates common-gates
     :trigger "manifest cell autonomous_weeding"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :harvest_coordination {:legacy-cell "harvest-coordination"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "harvest_coordination")]
     :required-gates common-gates
     :trigger "manifest cell harvest_coordination"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :soil_regeneration_audit {:legacy-cell "soil-regeneration-audit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "soil_regeneration_audit")]
     :required-gates common-gates
     :trigger "manifest cell soil_regeneration_audit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
